...
const projects = [
  {
    ...
    desc: "A multi-tenant SaaS booking platform built solo for local businesses. Each business gets its own subdomain and dashboard, with strict tenant-isolated data, Razorpay-powered subscriptions and bookings, and one codebase scaling to infinite tenants.",
    tech: "NEXT.JS / TS / DB"
  },
  {
    id: "02",
    ...
    desc: "An all-in-one business OS built solo for Indian freelancers — client management, GST-compliant invoicing, payment tracking, and a magic-link client portal in one place. Built to replace five disconnected tools with one that just works, India-first from day one.",
    tech: "NEXT.JS / TS / REDIS"
  },
  {
    id: "03",
    title: "MedLife",
